...
import net.sourceforge.opencamera.realcammi.remotecontrol.DeviceScanner;
...
public class PreferenceSubCameraControlsMore extends PreferenceSubScreen {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.preferences_sub_camera_controls_more, rootKey);
    }
            ...
            pref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    ...
                    if( main_activity.getStorageUtils().isUsingSAF() ) {
                        ...
                        fragment.show(getParentFragmentManager(), "FOLDER_FRAGMENT");
                        return true;
                    }
                }
            });
