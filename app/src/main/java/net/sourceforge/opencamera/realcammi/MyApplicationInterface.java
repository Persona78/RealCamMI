...
import net.sourceforge.opencamera.realcammi.preview.BasicApplicationInterface;
...
public class MyApplicationInterface extends BasicApplicationInterface {
    ...
    /** Whether the user has enabled the color correction post-processing option (RealCamMI fork
     *  feature: corrects the slight blue colour cast seen vs the stock camera app, applied as a
    ...
    public boolean getOpenCVSharpenPref() {
        return sharedPreferences.getBoolean(PreferenceKeys.OpenCVSharpenPreferenceKey, false);
    }
    ...
    @Override
    public boolean optimiseFocusForquality() {
        String pref = sharedPreferences.getString(PreferenceKeys.OptimiseFocusPreferenceKey, "preference_photo_optimise_focus_quality");
        return pref.equals("preference_photo_optimise_focus_quality") && main_activity.supportsOptimiseFocusquality();
    }
