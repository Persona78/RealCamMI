...
public class SaveLocationHandler {
     ...
     *  to the version of RealCamMI with scoped storage; or users who later upgrade to Android 10).
    ...
    public AlertDialog.Builder createSaveFolderDialog() {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(main_activity);
        editText.setText(sharedPreferences.getString(PreferenceKeys.SaveLocationPreferenceKey, "RealCamMI"));
