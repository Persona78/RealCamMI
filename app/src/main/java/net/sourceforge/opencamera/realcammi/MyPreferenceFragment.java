...
import net.sourceforge.opencamera.realcammi.ui.MyEditTextPreference;
...
public class MyPreferenceFragment extends PreferenceFragmentCompat implements OnSharedPreferenceChangeListener {
     ...
     * programmatically close the settings - this is done in MainActivity.onNewIntent(), so that if RealCamMI
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if( pref.getKey().equals("preference_about") ) {
                        ...
                        about_string.append("RealCamMI v");
    ...
    static void readFromBundle(PreferenceFragmentCompat preference_fragment, String [] values, String [] entries, String preference_key, String default_value, String preference_category_key) {
        if( MyDebug.LOG ) {
    ...
    public void onDestroy() {
        ...
        dismissDialogs(getParentFragmentManager(), dialogs);
    }
     ...
     * Without this, clicking ArraySeekBarPreference or MyEditTextPreference would crash because
     * the default implementation only knows about built-in preference types.
     */
    @Override
