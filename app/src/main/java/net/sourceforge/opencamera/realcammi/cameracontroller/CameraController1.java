    ...
    public CameraFeatures getCameraFeatures() throws CameraControllerException {
        ...
        if( camera_features.is_zoom_supported ) {
            ...
            try {
                ...
                // this is from java.lang.Integer.invalidInt(Integer.java:138) - unclear if this is a bug in RealCamMI, all we can do for now is catch it
    ...
    public SupportedValues setISO(String value) {
        ...
        if( iso_key != null ){
            if( values == null ) {
                ...
                values.add("800");
                values.add("1600");
                values.add("3200"); // add it for test
                values.add("6400"); // add it for test
            }
