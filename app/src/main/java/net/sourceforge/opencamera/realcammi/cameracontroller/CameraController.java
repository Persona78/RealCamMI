...
public abstract class CameraController {
    ...
    // default RealCamMI is 5, set 10 to for test
    public static final int N_IMAGES_NR_DARK = 10;
    ...
    public enum TonemapProfile {
        ...
        TONEMAPPROFILE_SRGB,
        // [REALCAMMI FORK] Sony S-Log3 logarithmic tonemap profile.
        // Lifts the black point and compresses highlights to maximise the sensor's dynamic range,
        // giving footage the widest possible tonal latitude for colour grading in post-production.
        // The curve is computed by getSlog3Profile() in Camera2Settings and applied via the
        // Android Camera2 TONEMAP_MODE_CONTRAST_CURVE API.
        // NOTE: footage recorded with this profile will look very flat and desaturated straight
        // from the camera. A LUT (e.g. S-Log3 to Rec.709) or manual colour grade is required
        // before the footage is suitable for viewing or sharing (DaVinci Resolve, CapCut, etc.).
        TONEMAPPROFILE_SLOG3,
        TONEMAPPROFILE_LOG,
        TONEMAPPROFILE_GAMMA,
        TONEMAPPROFILE_JTVIDEO,
        TONEMAPPROFILE_JTLOG,
        TONEMAPPROFILE_JTLOG2,
        TONEMAPPROFILE_SLOG3C
    }
