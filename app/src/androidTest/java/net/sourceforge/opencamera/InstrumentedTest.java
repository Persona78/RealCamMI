...
public class InstrumentedTest {
    ...
    private void switchToISO(int required_iso) {
        ...
        if( iso != required_iso ) {
            mActivityRule.getScenario().onActivity(activity -> {
                View exposureButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.exposure);
                View exposureContainer = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.exposure_container);
    ...
    private void subTestTakePhoto(boolean locked_focus, boolean immersive_mode, boolean touch_to_focus, boolean wait_after_focus, boolean single_tap_photo, boolean double_tap_photo, boolean is_raw, boolean test_wait_capture_result) throws InterruptedException {
        ...
        if( !single_tap_photo && !double_tap_photo ) {
            mActivityRule.getScenario().onActivity(activity -> {
                View takePhotoButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.take_photo);
    ...
    public void testTakePhotoRawOnly() throws InterruptedException {
        ...
        mActivityRule.getScenario().onActivity(activity -> {
            View switchVideoButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.switch_video);
    ...
    private void subTestTakePhotoMultiCameras(boolean cycle_all_cameras, boolean test_multi_cam) throws InterruptedException {
        ...
        for(int i=0;i<(cycle_all_cameras ? n_cameras-1 : 1);i++) {
            ...
            CharSequence contentDescription = getActivityValue(activity -> activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.switch_camera).getContentDescription());
            mActivityRule.getScenario().onActivity(activity -> {
                View switchCameraButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.switch_camera);
            ...
            CameraController.Facing new_facing = getActivityValue(activity -> activity.getPreview().getCameraControllerManager().getFacing(new_cameraId));
            CharSequence new_contentDescription = getActivityValue(activity -> activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.switch_camera).getContentDescription());
            ...
            mActivityRule.getScenario().onActivity(activity -> {
                switch( new_facing ) {
                    case FACING_FRONT:
                        assertEquals(contentDescription, activity.getResources().getString(net.sourceforge.opencamera.realcammi.R.string.switch_to_front_camera));
                        break;
                    case FACING_BACK:
                        assertEquals(contentDescription, activity.getResources().getString(net.sourceforge.opencamera.realcammi.R.string.switch_to_back_camera));
                        break;
                    case FACING_EXTERNAL:
                        assertEquals(contentDescription, activity.getResources().getString(net.sourceforge.opencamera.realcammi.R.string.switch_to_external_camera));
                        break;
                    default:
                        fail();
                }
                switch( next_facing ) {
                    case FACING_FRONT:
                        assertEquals(new_contentDescription, activity.getResources().getString(net.sourceforge.opencamera.realcammi.R.string.switch_to_front_camera));
                        break;
                    case FACING_BACK:
                        assertEquals(new_contentDescription, activity.getResources().getString(net.sourceforge.opencamera.realcammi.R.string.switch_to_back_camera));
                        break;
                    case FACING_EXTERNAL:
                        assertEquals(new_contentDescription, activity.getResources().getString(net.sourceforge.opencamera.realcammi.R.string.switch_to_external_camera));
                        break;
                    default:
                        fail();
                }
            ...
            if( !done_front_test && new_facing == CameraController.Facing.FACING_FRONT ) {
                ...
                CharSequence restart_contentDescription = getActivityValue(activity -> activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.switch_camera).getContentDescription());
                Log.d(TAG, "restart_contentDescription: " + restart_contentDescription);
                assertEquals(restart_cameraId, new_cameraId);
                mActivityRule.getScenario().onActivity(activity -> {
                    switch( next_facing ) {
                        case FACING_FRONT:
                            assertEquals(restart_contentDescription, activity.getResources().getString(net.sourceforge.opencamera.realcammi.R.string.switch_to_front_camera));
                            break;
                        case FACING_BACK:
                            assertEquals(restart_contentDescription, activity.getResources().getString(net.sourceforge.opencamera.realcammi.R.string.switch_to_back_camera));
                            break;
                        case FACING_EXTERNAL:
                            assertEquals(restart_contentDescription, activity.getResources().getString(net.sourceforge.opencamera.realcammi.R.string.switch_to_external_camera));
                            break;
                        default:
                            fail();
                    }
    ...
    public void testTakePhotoManualFocus() throws InterruptedException {
        ...
        mActivityRule.getScenario().onActivity(activity -> {
            SeekBar seekBar = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.focus_seekbar);
    ...
    private void setUpFocusBracketing() throws InterruptedException {
        mActivityRule.getScenario().onActivity(activity -> {
            SeekBar focusSeekBar = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.focus_seekbar);
        ...
        mActivityRule.getScenario().onActivity(activity -> {
            SeekBar focusTargetSeekBar = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.focus_bracketing_target_seekbar);
    ...
    public void testTakePhotoManualISOExposurePostCapture() throws InterruptedException {
        ...
        mActivityRule.getScenario().onActivity(activity -> {
            // open exposure UI
            View exposureButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.exposure);
            View exposureContainer = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.manual_exposure_container);
        ...
        mActivityRule.getScenario().onActivity(activity -> {
            View exposureButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.exposure);
            View exposureContainer = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.manual_exposure_container);
            SeekBar isoSeekBar = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.iso_seekbar);
            SeekBar exposureTimeSeekBar = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.exposure_time_seekbar);
            assertEquals(exposureButton.getVisibility(), View.VISIBLE);
            assertEquals(exposureContainer.getVisibility(), View.VISIBLE);
    ...
    public void testSettingsSlowPreviewStart() throws InterruptedException {
        ...
        mActivityRule.getScenario().onActivity(activity -> {
            View settingsButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.settings);
    ...
    private int subTestTakeVideo(boolean test_exposure_lock, boolean test_focus_area, boolean allow_failure, boolean immersive_mode, TestUtils.VideoTestCallback test_cb, long time_ms, boolean max_filesize, int n_non_video_files) throws InterruptedException {
        ...
        int exposureLockVisibility = getActivityValue(activity -> {
            View exposureLockButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.exposure_lock);
    ...
    private void subTestTakeVideoSnapshot() throws InterruptedException {
        ...
        mActivityRule.getScenario().onActivity(activity -> {
            View takePhotoVideoButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.take_photo_when_video_recording);
        ...
        subTestTakeVideo(false, false, false, false, new TestUtils.VideoTestCallback() {
            ...
            public int doTest() {
                ...
                mActivityRule.getScenario().onActivity(activity -> {
                    View takePhotoButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.take_photo);
                    View takePhotoVideoButton = activity.findViewById(net.sourceforge.opencamera.realcammi.R.id.take_photo_when_video_recording);
                    assertEquals(takePhotoButton.getContentDescription(), activity.getResources().getString(net.sourceforge.opencamera.realcammi.R.string.stop_video));
