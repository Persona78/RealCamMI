 ...
 *  On Android 10+, scoped storage permission needs to be given to RealCamMI for the DCIM/testOpenCamera/ folder.
 */
@RunWith(Categories.class)
@Categories.IncludeCategory(net.sourceforge.opencamera.PanoramaTests.class)
