...
import net.sourceforge.opencamera.realcammi.Preshots;
import net.sourceforge.opencamera.realcammi.SaveLocationHandler;
...
import net.sourceforge.opencamera.realcammi.preview.VideoQualityHandler;
import net.sourceforge.opencamera.realcammi.TextFormatter;
...
public class UnitTest {
    ...
    public void testNRSceneIsLowLight() {
        ...
        // ISO > 400 OR Shutter Speed slower than 1/50s (20,000,000 ns)
        assertTrue(HDRProcessor.sceneIsLowLight(400, 1000000000L / 50));

        // ISO > 800 OR Shutter Speed slower than 1/30s (33,333,333 ns)
        assertTrue(HDRProcessor.sceneIsLowLight(800, 1000000000L / 30));
    }
